...
@Service
public class ProducerMessageOutService {
    private final RabbitTemplate rabbitTemplate;
    private final String energyQueue;

    public ProducerMessageOutService(RabbitTemplate rabbitTemplate, @Value("${rabbitmq.queue.energy}") String energyQueue) {
        this.rabbitTemplate = rabbitTemplate;
        this.energyQueue = energyQueue;
    }

    public void sendProducerMessage(ProducerMessageOutDto message) {
